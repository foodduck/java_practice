...
<ul class="lst lh">
	...
	<li class="item3">아이디</li>
	<li class="item4">내용</li>
	<li class="item5">글쓴이</li>
	<li class="item6">등록일자</li>
	<li class="item7">조회수</li>
</ul>
<form action="DeleteNoticeCtrl" method="post" nameW="delForm" onsubmit="return frm_submit(this)">
<%	
...
%>	
	<ul class="lst">
		...
		<li class="item1"><a href="EditNoticeFormCtrl?idx=<%=noti.getIdx() %>"><%=noti.getTitle() %></a></li>
