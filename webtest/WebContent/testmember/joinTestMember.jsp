...
<%@ page import = "test.model.TestMemberVO" %>    
<%@ page import = "test.biz.TestMemberDAO" %>   
<%@ page import = "test.controller.JoinTestMemberCtrl" %>
    
<%
	TestMemberVO TestMember = (TestMemberVO) request.getAttribute("TestMember");
%>    
<!DOCTYPE html>
<html>
<head>
...
<div class = "container">
	<h2>회원가입</h2>
	<form action="../InsertTestMemberCtrl" method="post" name="jonform" onsubmit="return joinCheck(this)">
	<table class = "table">
		<tr>
