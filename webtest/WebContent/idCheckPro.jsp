...
<%
		...
		try {
			...
			out.println(mid+"가 입력되었습니다.");
			sql = "select * from testmember where id=?";
...
<%		
			if(rs.next()) {
				...
				out.println("<a href='javascript:apply(\""+mid+"\")'>"+mid+"[적용]</a>");
...
<script>
			function apply(id) {
				...
				//입력후 readonly
				//opener.document.joinform.mid.readonly=true;
