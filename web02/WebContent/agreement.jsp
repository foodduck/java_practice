...
<title>약관 동의</title>
<style>
.form_fr { margin:20px; height:20; text-align:center}
</style>
</head>
<body>
 <%@ include file = "header.jsp"%>
 <form action = "join.jsp" class = "frm" method="post" onsubmit ="return send(this)">
 <div class="form_fr">
 <h2>회원 약관</h2>
...
8.회원의 개인정보 이용에 대한 동의는 회원이 본 약관에 동의(2조4항에따른 동의로 보는 경우 포함)하는 것으로서 갈음합니다.
 ...
 <div style="text-align: center" class="form_fr">
 	<input type="checkbox" name = "agree2" required> 동의
